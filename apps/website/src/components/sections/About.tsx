...
export function About() {
  return (
    <section id="about" className="bg-mist/40 py-12 sm:py-16">
      <Container className="grid items-center gap-14 lg:grid-cols-2 lg:gap-20">
        <Reveal>
          ...
          <h2 className="mt-4 text-balance text-section-mobile font-semibold tracking-tight text-foreground sm:text-section">
            Built for the way{" "}
            <span className="font-script text-[1.3em] font-normal leading-[0.8] tracking-normal text-primary">
              Chennai moves.
            </span>
          </h2>
        ...
        <Reveal className="relative" delay={150}>
          <div
            aria-hidden
            className="absolute inset-0 -z-10 rounded-[3rem] bg-gradient-to-br from-sage via-background to-mist"
          />
