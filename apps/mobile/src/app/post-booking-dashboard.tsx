...
/**
 * The rider's dashboard once they have an active rental — this is the
 * former Home Screen content, moved here unchanged so it becomes the
 * "Post-Booking Dashboard". Reachable only when profile.has_active_rental
 * is true (enforced in _layout.tsx); everyone else lands on /home instead.
 * Still backed by the mock useFleetStore, same as before this move.
 */
