...
export const ta: Copy = {
    ...
    'booking.startsNow.title': 'உங்கள் திட்டம் இன்று மதியம் 12:00 மணிக்குத் தொடங்குகிறது',
    'booking.startsNow.body':
        'நீங்கள் பணம் செலுத்திய பிறகு, பிக்கப் நிலையத்திற்குச் சென்று காலை 8 – இரவு 8 மணிக்குள் உங்கள் ஸ்கூட்டரைப் பெறுங்கள். நீங்கள் எப்போது பெற்றாலும், ஒவ்வொரு வாடகையும் மதியம் 12:00 முதல் மதியம் 12:00 வரை நிலையான சுழற்சியில் இயங்கும்.',
    ...
    'deposit.refunded': 'உங்கள் பணம் திரும்பச் செலுத்தப்பட்டுவிட்டது.',
    ...
    'booking.nonRefundable': 'திரும்பத் தரப்படாது',
    'booking.refundable': 'திரும்பத் தரப்படும்',
    'booking.refundableAfterDays': '{days} வாடகை நாட்களுக்குப் பிறகு திரும்பத் தரப்படும்',
    'booking.upfrontBreakdown': '{amount} முன்பணம் விவரம்',
    'booking.depositTerms':
        '{onboarding} சேர்க்கைக் கட்டணம் திரும்பத் தரப்படாது. {deposit} பாதுகாப்பு வைப்புத்தொகை திரும்பத் தரப்படும்; சேதம், நிலுவைத் தொகை, அபராதம் அல்லது பிற பொருந்தும் கட்டணங்கள் கழிக்கப்படலாம்.',
    'booking.depositTermsWithDays':
        '{onboarding} சேர்க்கைக் கட்டணம் திரும்பத் தரப்படாது. குறைந்தபட்சம் {days} வாடகை நாட்களை நீங்கள் முடித்த பிறகு {deposit} பாதுகாப்பு வைப்புத்தொகை திரும்பத் தரப்படும்; சேதம், நிலுவைத் தொகை, அபராதம் அல்லது பிற பொருந்தும் கட்டணங்கள் கழிக்கப்படலாம்.',
    ...
    'booking.cancellationNoteWithOnboarding':
        'முன்பதிவு செய்த {minutes} நிமிடங்களுக்குள் ரத்து செய்தால் திட்டத் தொகையில் {percent}% பிடித்து வைக்கப்படும்; காத்திருக்கும் நேரம் அதிகரிக்க கட்டணமும் அதிகரிக்கும். வாகனத்தைப் பெறும் முன் ரத்து செய்தால் உங்கள் பாதுகாப்பு வைப்புத்தொகை முழுவதுமாகத் திரும்பத் தரப்படும், ஆனால் சேர்க்கைக் கட்டணம் திரும்பத் தரப்படாது.',
    'booking.amount': 'தொகை',
