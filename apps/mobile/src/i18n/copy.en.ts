...
export const en = {
    ...
    'privacy.data.export': 'Download a copy of your data',
    'privacy.data.export.help': 'We will prepare a file with everything we hold about you.',
    'privacy.data.export.preparing': 'Preparing your file...',
    'privacy.data.export.ready': 'Your file is ready. The link works for 5 minutes.',
